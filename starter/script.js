...
const tabsContants = document.querySelectorAll('.operations__content');
...
// 1. Add event lsitener to common parent elemnt
...
tabContainer.addEventListener('click', function (e) {
  ...
  tabsContants.forEach(c => c.classList.remove('operations__content--active'));
...
const newFeature = function () {
  console.log('Welcome to the application <3');
};
...
// Oldschool method to add evenetlisteners
